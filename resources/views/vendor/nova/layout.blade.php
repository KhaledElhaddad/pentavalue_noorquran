        ...
        <div class="content">
            <div class="flex items-center relative shadow h-header bg-white z-20 px-view">
                ...
                <div class="ml-auto h-9 flex items-center dropdown-right">
                    ...
                    <ul class="m-auto" style="display: flex; list-style: none;">
                        <li style="text-decoration: none;">
                            <a href="/lang/en" style="text-decoration: none; color: #455366;">English</a>
                        </li>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <li style="">
                            <a href="/lang/ar" style="text-decoration: none; color: #455366;">عربي</a>
                        </li>
                        &nbsp;&nbsp;&nbsp;
                    </ul>
                </div>
